...
function HomePage() {
  ...
  var autoSlideIntervalRef = useRef(null);
  ...
  useEffect(() => {
    ...
    const updateSliderPos = (sliderItems) => {
      if (currentSlidePos < 0) {
        setCurrentSlidePos(sliderItems.length - 1);
      } else if (currentSlidePos >= sliderItems.length) {
        setCurrentSlidePos(0);
      }

      const lastActiveSliderItem = sliderItems[currentSlidePos];
    ...
    const slideNext = (sliderItems) => {
      setCurrentSlidePos((prevPos) => (prevPos + 1) % sliderItems.length);
    };

    const slidePrev = (sliderItems) => {
      setCurrentSlidePos((prevPos) => (prevPos - 1 + sliderItems.length) % sliderItems.length);
    };

    const autoSlide = (sliderItems) => {
    ...
    const handleScroll = () => {
      ...
      setIsScrollBottom(lastScrollPos < currentScrollPos);
    ...
    updateSliderPos(heroSliderItems);
    autoSlide(heroSliderItems);

    const heroSliderNextBtn = document.querySelector("[data-next-btn]");
    const heroSliderPrevBtn = document.querySelector("[data-prev-btn]");
    addEventOnElements([heroSliderNextBtn, heroSliderPrevBtn], "mouseover", handleMouseOver);
    addEventOnElements([heroSliderNextBtn, heroSliderPrevBtn], "mouseout", handleMouseOut);
  ...
  }, [currentSlidePos, autoSlideInterval]);
    return (
      <>
       {!isPreloaderLoaded && (
        <div className="preload" data-preaload>
          <div className="circle"></div>
          <p className="text">Eiko Patisserie </p>
        </div>
      )}
        ...
        <main>
          <article>
            ...
            <section
              ...
              style={{ backgroundImage: 'url(\'./assets/images/testimonial-bg.jpg\')', backgroundSize: 'cover' }}              
            ...
            <section className="reservation">
              <div className="container">
                <div className="form reservation-form bg-black-10" style={{border: '1px solid'}}>
                  ...
                  <div
                    ...
                    style={{ backgroundColor:'#faf395', backgroundSize: 'cover' }}
                  >
        ...
        <footer
          ...
          style={{ backgroundImage: 'url(\'./assets/images/footer-bg.jpg\')', backgroundSize: 'cover' }}
        >
          <div className="container">
            <div className="footer-top grid-list">
              ...
              <ul className="footer-list">
                ...
                <li>
                  <a href="https://www.instagram.com/eiko.patisserie/" className="label-2 footer-link hover-underline">
                    Instagram
                  </a>
                </li>
